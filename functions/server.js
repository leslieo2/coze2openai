...
import serverless from "serverless-http"; // 引入 serverless-http 将 Express 应用转化为 Netlify Function
...
module.exports.handler = serverless(app); // 导出为 Netlify Functions 处理程序
